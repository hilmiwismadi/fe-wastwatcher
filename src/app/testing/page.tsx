  ...
  useEffect(() => {
    ...
    ws.onmessage = (event) => {
      try {
        ...
        // ====================================
        // PARSING FORMAT BARU DARI MQTT
        // ====================================
        // Format dari backend:
        // {
        //   location: "KantinSGLC",
        //   timestamp: "2025-10-22T14:10:22.191Z",
        //   binType: "organic",
        //   data: {
        //     sensors: { topLeft: 60, topRight: 59, bottomLeft: 75, bottomRight: 73 },
        //     average: 67
        //   }
        // }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">
            🗑️ MQTT Waste Bin Testing Dashboard
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• Topic: <code className="bg-white px-2 py-1 rounded text-xs">CapsE6/KantinSGLC</code></li>
                <li>• Data: <code className="bg-white px-2 py-1 rounded text-xs">{`{"DISTANCE":[60,59,75,73],"WEIGHT":2454}`}</code></li>
                <li>• Bin: <strong>Organic only</strong> (4 sensors + weight)</li>
            ...
            <div>
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• Topic: <code className="bg-white px-2 py-1 rounded text-xs">CapsE6/KantinSGLC/Organic</code></li>
                <li>• Topic: <code className="bg-white px-2 py-1 rounded text-xs">CapsE6/KantinSGLC/Anorganic</code></li>
                <li>• Topic: <code className="bg-white px-2 py-1 rounded text-xs">CapsE6/KantinSGLC/Residue</code></li>
